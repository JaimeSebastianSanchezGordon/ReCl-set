...
@section('page_subtitle', 'Completa los datos de tu prenda para publicarla en ReClóset.')
...
@section('content')
    ...
    >
        ...
        <div class="mt-8 flex items-center gap-3 border-t border-stone-150 pt-6">
            ...
            <a class="text-xs font-bold text-stone-600 hover:text-stone-800 transition inline-flex items-center gap-1 uppercase tracking-wider cursor-pointer" href="{{ route('garments.my') }}">
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
