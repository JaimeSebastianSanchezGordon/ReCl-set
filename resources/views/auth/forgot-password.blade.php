...
<div class="relative py-8 flex items-center justify-center overflow-hidden w-full">
    <section class="w-full max-w-md glass-card rounded-3xl p-8 relative z-10 transition duration-300">
        ...
        <div class="flex flex-col items-center mb-6">
            ...
            <h2 class="text-xl font-extrabold text-stone-900 tracking-tight">Recuperar contraseña</h2>
            <p class="text-xs text-stone-500 font-medium text-center mt-1">Ingresa tu correo y te enviaremos un enlace seguro para crear una nueva contraseña.</p>
        </div>
